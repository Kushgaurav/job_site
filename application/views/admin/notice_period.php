...
<div class="hs_alert_wrapper open_alert  hs_success msg1">
    <div class="hs_alert_inner">
        <p> <span class="icon"></span>1 Notice Period <?= $msg ?></p>
    </div>
</div>
<?php
}
...
<div class="row" onload="location_fetch()">
    <div class="col-md-12">
        <div class="hs_heading medium">
            <h3>All Notice Period (<?= $this->Common_model->row_count('notice_period'); ?>)
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="hs_input">
                    ...
                    <form action="add_notice_period" method="POST">
                        <div class="hs_input">
                            <input type="text" name="name" id="name1" class="form-control"
                                placeholder="notice_period Name">
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="hs_input">
                    <label>Notice Period</label>
                    <form action="updatenotice_period" method="POST">
                        <div id="data_disp">
