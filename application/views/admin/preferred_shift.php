...
<div class="hs_alert_wrapper open_alert  hs_success msg1">
    <div class="hs_alert_inner">
        <p> <span class="icon"></span>1 Preferred Shift <?= $msg ?></p>
    </div>
</div>
<?php
}
...
<div class="row" onload="location_fetch()">
    <div class="col-md-12">
        <div class="hs_heading medium">
            <h3>All Preferred Shift (<?= $this->Common_model->row_count('preferred_shift'); ?>)
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Add Preferred Shift</h4>
            </div>
            <div class="modal-body">
                <div class="hs_input">
                    <label>Preferred Shift</label>
                    <form action="add_preferred_shift" method="POST">
                        <div class="hs_input">
                            <input type="text" name="name" id="name1" class="form-control"
                                placeholder="preferred_shift Name">
                        </div>
...
<div id="update_desi_popup" class="modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Update Preferred Shift</h4>
            </div>
            <div class="modal-body">
                <div class="hs_input">
                    <label>Preferred Shift</label>
                    <form action="updatepreferred_shift" method="POST">
                        <div id="data_disp">
