...
<div class="jp_job_box">
    <div class="job_detail">
        ...
        <ul>
            ...
            <li><span><img src="<?= base_url('assets/images/location.svg'); ?>" alt=""></span> <?= $r1->job_location; ?>
            </li>
        </ul>
        <h4>
    ...
    <div class="jp_view_btn">
        <a href="<?= base_url('home/user_jobsingle/'.$r1->id); ?>"
            class="jp_btn jp_btn_block"><?= $controller->set_language('my_a_view') ?></a>
    </div>
</div>
