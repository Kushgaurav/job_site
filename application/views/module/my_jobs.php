        ...
        <div class="col-md-12">
            ...
            <div class="jp_job_box">
                <div class="job_detail">
                    <h3><?= $res->designation ?></h3>
                    <span><a
                            href="<?= base_url('recruiter/applied_user/'.$res->id); ?>"><?= $res->application." "; ?><?= $controller->set_language('r_applied'); ?></a></span>
                    <ul>
                        <li title="<?= $controller->set_language('r_tool_tip1'); ?>"><span><img
                                    src="<?= base_url('assets/images/experience.svg'); ?>" alt=""></span>
                            <?= $res->exp; ?></li>
                        <li title="<?= $controller->set_language('r_tool_tip2'); ?>"><span><img
                                    src="<?= base_url('assets/images/location.svg'); ?>" alt=""></span>
                            <?= $res->state.",".$res->city.",".$res->locality; ?></li>
                    </ul>
                ...
                <div class="jp_view_btn">
                    <a href="<?= base_url('recruiter/user_jobsingle/'.$res->id); ?>"
                        class="jp_btn jp_btn_block"><?= $controller->set_language('r_view'); ?></a>
                    <a href="<?= base_url('recruiter/delete_job/'.$res->id); ?>" class="jp_btn jp_btn_block">Delete</a>
                    <a href="<?= base_url('recruiter/edit_job_post/'.$res->id); ?>"
                        class="jp_btn jp_btn_block"><?= $controller->set_language('r_edit'); ?></a>
                </div>
            </div>
            <?php
					}
