 ...
 <div class="jp_job_box">
     <div class="job_detail">
         ...
         <span><?= $res->application ?> <?= $controller->set_language('applied_keyword'); ?></span>
         <ul>
             <li title="<?= $controller->set_language('h_work_exp'); ?>"><span><img
                         src="<?= base_url('assets/images/experience.svg'); ?>" alt=""></span> <?= $res->exp; ?></li>
             <li title="<?= $controller->set_language('h_job_location'); ?>"><span><img
     ...
     <div class="jp_view_btn">
         <a href="<?= base_url('job/user_jobsingle/'.$res->id); ?>"
             class="jp_btn jp_btn_block"><?= $controller->set_language('view_btn'); ?></a><br><br>.
     </div>
     <?php
							...
							if($check_status>0)
							{
								?>
     <div class="jp_view_btn">
         <a href="<?= base_url('home/user_jobsingle/'.$res->id); ?>"
             class="jp_btn jp_btn_block"><?= $controller->set_language('applied_keyword'); ?></a>
     </div>
     <?php
							}
							}
