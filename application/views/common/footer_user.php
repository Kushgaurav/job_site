                                    ...
                                    <div class="single-footer-caption mb-50">
                                        <div class="single-footer-caption mb-30">
                                            <div class="footer-tittle">
                                                ...
                                                <a href="<?= base_url('home/about'); ?>" style="color: white;">show
                                                    more</a>
                                            </div>
                                        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="jp_copyright_content jp-crnew">
                    ...
                    <ul>
                        ...
                        <li><a
                                href="<?= base_url('home/policy'); ?>"><?php  echo $controller->set_language('ptivcy_keyword'); ?></a>
                        </li>
                        <li><a
                                href="<?= base_url('home/about'); ?>"><?php  echo $controller->set_language('about_keyword'); ?></a>
                        </li>
                        <li><a
                                href="<?= base_url('home/contact'); ?>"><?php  echo $controller->set_language('contect_keyword'); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
