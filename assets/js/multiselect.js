function MultiSelectTag(e, t = {
    ...
    function E(e = !0) {
        selected_values = [];
        for (var d = 0; d < l.length; d++) n.options[d].selected = l[d].selected, l[d].selected && selected_values.push({
            label: l[d].label,
            value: l[d].value
        });
